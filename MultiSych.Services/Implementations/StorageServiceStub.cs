...
namespace MultiSych.Services.Implementations
{
    public class StorageServiceStub : IStorageService
    {
        ...
        public Task<bool> MoveFileAsync(AccountCredentials credentials, string fileId, string newParentId, string? newFileName = null)
        {
            _logger.Information("[StorageServiceStub] MoveFileAsync called for fileId={FileId}, newParentId={NewParentId}, newName={NewName}.", fileId, newParentId, newFileName);
            return Task.FromResult(true);
        }
